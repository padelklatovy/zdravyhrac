...
const DS = (() => {
  ...
  const demoData = {
    ...
    exercises: [
      { id: 'e1', name: 'Rotátorová manžeta', area: 'rameno', desc: 'Posilování vnitřní a vnější rotace s gumou', sets: '3 × 15', level: 'lehké', pillar: 1 },
      { id: 'e2', name: 'Nordic hamstring', area: 'koleno', desc: 'Excentrické posilování zadní stehenní skupiny', sets: '3 × 8', level: 'střední', pillar: 1 },
      { id: 'e3', name: 'Forearm flexor stretch', area: 'loket', desc: 'Protažení flexorů předloktí', sets: '3 × 30s', level: 'lehké', pillar: 4 },
      { id: 'e4', name: 'Diafragmatický dech', area: 'dech', desc: 'Břišní dýchání pro regeneraci a klid', sets: '5 min', level: 'lehké', pillar: 2 },
      { id: 'e5', name: 'Hip flexor stretch', area: 'kycel', desc: 'Uvolnění flexorů kyčle po hře', sets: '2 × 45s', level: 'lehké', pillar: 4 },
    ],
    tips: [
